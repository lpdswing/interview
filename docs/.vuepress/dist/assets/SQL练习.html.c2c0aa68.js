...
<span class="token keyword">WHERE</span>
    id <span class="token operator">NOT</span> <span class="token operator">IN</span> <span class="token punctuation">(</span> 
        ...
        <span class="token keyword">GROUP</span> <span class="token keyword">BY</span> email 
    <span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,73),v={href:"https://stackoverflow.com/questions/45494/mysql-error-1093-cant-specify-target-table-for-update-in-from-clause",target:"_blank",rel:"noopener noreferrer"},m=a(`<h3 id="sql-schema-5" tabindex="-1"><a class="header-anchor" href="#sql-schema-5" aria-hidden="true">#</a> SQL Schema</h3><p>\u4E0E 182 \u76F8\u540C\u3002</p><h2 id="_175-combine-two-tables" tabindex="-1"><a class="header-anchor" href="#_175-combine-two-tables" aria-hidden="true">#</a> 175. Combine Two Tables</h2><p>https://leetcode.com/problems/combine-two-tables/description/</p><h3 id="description-6" tabindex="-1"><a class="header-anchor" href="#description-6" aria-hidden="true">#</a> Description</h3><p>Person \u8868\uFF1A</p><div class="language-html ext-html line-numbers-mode"><pre class="language-html"><code>+-------------+---------+
| Column Name | Type    |
+-------------+---------+
| PersonId    | int     |
| FirstName   | varchar |
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,125);function b(h,y){const t=i("ExternalLinkIcon");return l(),c("div",null,[r,e(" GFM-TOC "),u,e(" GFM-TOC "),k,n("p",null,[s("\u53C2\u8003\uFF1A"),n("a",v,[s("pMySQL Error 1093 - Can't specify target table for update in FROM clause"),o(t)])]),m])}const w=p(d,[["render",b],["__file","SQL\u7EC3\u4E60.html.vue"]]);export{w as default};
